...
public class Person {
    ...
    public List<BankCard> getBankCards() {
        if (bankCards == null) {
            ...
            BankCardDao targetDao = daoSession.getBankCardDao();
            List<BankCard> bankCardsNew = targetDao._queryPerson_BankCards(id);
            synchronized (this) {
                if (bankCards == null) {
                    bankCards = bankCardsNew;
                }
            }
        }
        return bankCards;
    ...
    @Generated(hash = 1279981409)
    public synchronized void resetBankCards() {
        bankCards = null;
    }
